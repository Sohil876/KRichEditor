...
import com.ebolo.krichtexteditor.fragments.KRichEditorView
...
class KRichEditorViewLayout : AnkoComponent<KRichEditorView> {
    ...
    override fun createView(ui: AnkoContext<KRichEditorView>) = rootView ?: with(ui) {
        ...
        rootView = verticalLayout {
            ...
            webView = ankoView(::TextEditorWebView, 0) {
                ...
                editor.apply {
                    ...
                    placeHolder = this@KRichEditorViewLayout.placeHolder
                    onInitialized = {
                        this@KRichEditorViewLayout.onInitialized?.invoke()
